...
Welcome to `venvr` contributor's guide.
...
If you experience bugs or general issues with `venvr`, please have a look
...
You can help improve `venvr` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`venvr` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `venvr`'s files. While this mechanism can
...
```
conda create -n venvr python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/venvr.git
   cd venvr
   ```
...
5. Install [pre-commit]:
   ...
   `venvr` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/venvr
[issue tracker]: https://github.com/<USERNAME>/venvr/issues
